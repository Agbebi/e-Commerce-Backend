...
const registerDispatchAgent = async (req, res) => {
    const {name, email, phoneNumber, vehicleDetails, password} = req.body


    try {

        const checkUser = await DispatchAgent.findOne({email})
        ...
        const newUser = new DispatchAgent({
...
const loginDispatchAgent = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({
            ...
            vehicleDetails : checkUser.vehicleDetails,
...
module.exports = { registerDispatchAgent, loginDispatchAgent, logoutDispatchAgent, authMiddleware }
